...
var vec__48281_48284 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_48285 = cljs.core.nth.call(null,vec__48281_48284,(0),null);
var only_after_48286 = cljs.core.nth.call(null,vec__48281_48284,(1),null);
var db_changed_QMARK__48287 = (cljs.core.some_QMARK_.call(null,only_before_48285)) || (cljs.core.some_QMARK_.call(null,only_after_48286));
if(db_changed_QMARK__48287){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_48285);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_48286);
...
var map__48294 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48294__$1 = ((((!((map__48294 == null)))?((((map__48294.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48294.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48294):map__48294);
var db = cljs.core.get.call(null,map__48294__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__48294__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__48302 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__48302__$1;
var event = cljs.core.get.call(null,map__48302__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__47522__auto___48305 = arguments.length;
var i__47523__auto___48306 = (0);
while(true){
if((i__47523__auto___48306 < len__47522__auto___48305)){
args__47529__auto__.push((arguments[i__47523__auto___48306]));

var G__48307 = (i__47523__auto___48306 + (1));
i__47523__auto___48306 = G__48307;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__47530__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq48304){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48304));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__46447__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__47529__auto__ = [];
var len__47522__auto___48313 = arguments.length;
var i__47523__auto___48314 = (0);
while(true){
if((i__47523__auto___48314 < len__47522__auto___48313)){
args__47529__auto__.push((arguments[i__47523__auto___48314]));

var G__48315 = (i__47523__auto___48314 + (1));
i__47523__auto___48314 = G__48315;
continue;
} else {
}
break;
...
var argseq__47530__auto__ = ((((2) < args__47529__auto__.length))?(new cljs.core.IndexedSeq(args__47529__auto__.slice((2)),(0),null)):null);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__47530__auto__);
});
...
return (function (p1__48308_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__48308_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__48309_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__48309_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq48310){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__48311,G__48312,seq48310__$2);
});
