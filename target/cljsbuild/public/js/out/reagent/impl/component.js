...
if((i < len)){
var k = (ks[i]);
var G__38665 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38666 = (i + (1));
m = G__38665;
i = G__38666;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__38670 = c;
var G__38670__$1 = (((G__38670 == null))?null:G__38670.prototype);
if((G__38670__$1 == null)){
return null;
} else {
return (G__38670__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__38674 = c;
var G__38674__$1 = (((G__38674 == null))?null:G__38674.prototype);
if((G__38674__$1 == null)){
return null;
} else {
return (G__38674__$1["render"]);
}
})()));
});
...
return (function() { 
var G__38678__delegate = function (args){
...
while (G__38679__i < G__38679__a.length) {G__38679__a[G__38679__i] = arguments[G__38679__i + 0]; ++G__38679__i;}
  args = new cljs.core.IndexedSeq(G__38679__a,0);
} 
return G__38678__delegate.call(this,args);};
G__38678.cljs$lang$maxFixedArity = 0;
G__38678.cljs$lang$applyTo = (function (arglist__38680){
var args = cljs.core.seq(arglist__38680);
return G__38678__delegate(args);
});
...
var _STAR_current_component_STAR_38683 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_38683;
}});
...
var G__38687 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__38687) {
...
var or__36967__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__38689_38691 = (c["cljsRatom"]);
if((G__38689_38691 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38689_38691);
}
...
if(cljs.core.truth_((function (){var and__36955__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_38694))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_38695)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_38695))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__36967__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__36967__auto__)){
return or__36967__auto__;
} else {
...
var render_fun__$1 = (function (){var or__36967__auto__ = render_fun;
if(cljs.core.truth_(or__36967__auto__)){
return or__36967__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__36967__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__36967__auto__)){
return or__36967__auto__;
} else {
...
var name__$1 = (function (){var G__38693 = name;
switch (G__38693) {
case "":
...
var G__38698 = o;
(G__38698[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__38704 = (function (){var or__36967__auto__ = (function (){var G__38706 = c;
if((G__38706 == null)){
return null;
} else {
return (G__38706["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__36967__auto__)){
return or__36967__auto__;
...
return (G__38704["_currentElement"]);
}
})();
var name = (function (){var G__38707 = elem;
var G__38707__$1 = (((G__38707 == null))?null:(G__38707["type"]));
if((G__38707__$1 == null)){
return null;
} else {
return (G__38707__$1["displayName"]);
}
})();
var path = (function (){var G__38708 = elem;
var G__38708__$1 = (((G__38708 == null))?null:(G__38708["_owner"]));
var G__38708__$2 = (((G__38708__$1 == null))?null:reagent$impl$component$component_path.call(null,G__38708__$1));
if((G__38708__$2 == null)){
return null;
} else {
return [cljs.core.str(G__38708__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__36967__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__36967__auto__)){
return or__36967__auto__;
} else {
var G__38710 = c;
var G__38710__$1 = (((G__38710 == null))?null:G__38710.constructor);
if((G__38710__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__38710__$1);
}
}
})();
