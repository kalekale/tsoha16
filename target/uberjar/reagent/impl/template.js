...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6910__auto__,writer__6911__auto__,opt__6912__auto__){
return cljs.core._write(writer__6911__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12665 = o;
(G__12665[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12666__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12666 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12667__i = 0, G__12667__a = new Array(arguments.length -  0);
while (G__12667__i < G__12667__a.length) {G__12667__a[G__12667__i] = arguments[G__12667__i + 0]; ++G__12667__i;}
  args = new cljs.core.IndexedSeq(G__12667__a,0);
} 
return G__12666__delegate.call(this,args);};
G__12666.cljs$lang$maxFixedArity = 0;
G__12666.cljs$lang$applyTo = (function (arglist__12668){
var args = cljs.core.seq(arglist__12668);
return G__12666__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6292__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6292__auto__){
var and__6292__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6292__auto____$1)){
...
var G__12674 = jsprops;
(G__12674["defaultValue"] = value);

(G__12674["onChange"] = ((function (G__12674,v,value,on_change){
return (function (p1__12671_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12671_SHARP_);
});})(G__12674,v,value,on_change))
);

(G__12674["ref"] = ((function (G__12674,v,value,on_change){
return (function (p1__12672_SHARP_){
return (this$["cljsInputElement"] = p1__12672_SHARP_);
});})(G__12674,v,value,on_change))
);
...
var vec__12681 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12681,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12681,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12681,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12686 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12686 == null)){
} else {
var key_12687 = temp__4661__auto___12686;
(jsprops["key"] = key_12687);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12689 = (new reagent.impl.template.NativeWrapper());
(G__12689["name"] = c);
...
var G__12691 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12691) : reagent.impl.template.as_element.call(null,G__12691));
} else {
...
var len__7379__auto___12697 = arguments.length;
var i__7380__auto___12698 = (0);
while(true){
if((i__7380__auto___12698 < len__7379__auto___12697)){
args__7386__auto__.push((arguments[i__7380__auto___12698]));

var G__12699 = (i__7380__auto___12698 + (1));
i__7380__auto___12698 = G__12699;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7387__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12695){
var G__12696 = cljs.core.first(seq12695);
var seq12695__$1 = cljs.core.next(seq12695);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12696,seq12695__$1);
});
...
break;
default:
var G__12703 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12703;
continue;
...
var n__7219__auto___12706 = a.length;
var i_12707 = (0);
while(true){
if((i_12707 < n__7219__auto___12706)){
(a[i_12707] = reagent.impl.template.as_element((a[i_12707])));

var G__12708 = (i_12707 + (1));
i_12707 = G__12708;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7219__auto___12709 = a.length;
var i_12710 = (0);
while(true){
if((i_12710 < n__7219__auto___12709)){
var val_12711 = (a[i_12710]);
if((cljs.core.vector_QMARK_(val_12711)) && ((reagent.impl.template.key_from_vec(val_12711) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12710] = reagent.impl.template.as_element(val_12711));

var G__12712 = (i_12710 + (1));
i_12710 = G__12712;
continue;
} else {
}
...
var ctx = ({});
var vec__12716 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12716,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12716,(1),null);
...
var G__12720 = (cljs.core.count(argv) - first_child);
switch (G__12720) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12720){
