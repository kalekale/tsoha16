...
if((i < len)){
var k = (ks[i]);
var G__12580 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12581 = (i + (1));
m = G__12580;
i = G__12581;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12585 = c;
var G__12585__$1 = (((G__12585 == null))?null:G__12585.prototype);
if((G__12585__$1 == null)){
return null;
} else {
return (G__12585__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12589 = c;
var G__12589__$1 = (((G__12589 == null))?null:G__12589.prototype);
if((G__12589__$1 == null)){
return null;
} else {
return (G__12589__$1["render"]);
}
})()));
});
...
var G__12593 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12593) : reagent.impl.component.as_element.call(null,G__12593));
};
...
var _STAR_current_component_STAR_12600 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12600;
}});
...
var G__12608 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12608) {
...
return ((function (G__12608){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12611 = reagent.impl.component.state_atom(c);
var G__12612 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12611,G__12612) : cljs.core.reset_BANG_.call(null,G__12611,G__12612));
});
;})(G__12608))
...
var or__6304__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12614_12616 = (c["cljsRatom"]);
if((G__12614_12616 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12614_12616);
}
...
if(cljs.core.truth_((function (){var and__6292__auto__ = wrap;
...
var renders_12619 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12620 = cljs.core.first(cljs.core.vals(renders_12619));
if((cljs.core.count(renders_12619) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12619))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12620)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12620], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6304__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6304__auto__)){
return or__6304__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6304__auto__ = render_fun;
if(cljs.core.truth_(or__6304__auto__)){
return or__6304__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6304__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6304__auto__)){
return or__6304__auto__;
} else {
...
var name__$1 = (function (){var G__12618 = name;
switch (G__12618) {
case "":
...
var elem = (function (){var G__12629 = (function (){var or__6304__auto__ = (function (){var G__12631 = c;
if((G__12631 == null)){
return null;
} else {
return (G__12631["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6304__auto__)){
return or__6304__auto__;
...
return (G__12629["_currentElement"]);
}
})();
var name = (function (){var G__12632 = elem;
var G__12632__$1 = (((G__12632 == null))?null:(G__12632["type"]));
if((G__12632__$1 == null)){
return null;
} else {
return (G__12632__$1["displayName"]);
}
})();
var path = (function (){var G__12633 = elem;
var G__12633__$1 = (((G__12633 == null))?null:(G__12633["_owner"]));
var G__12633__$2 = (((G__12633__$1 == null))?null:reagent$impl$component$component_path(G__12633__$1));
if((G__12633__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12633__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6304__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6304__auto__)){
return or__6304__auto__;
} else {
var G__12635 = c;
var G__12635__$1 = (((G__12635 == null))?null:G__12635.constructor);
if((G__12635__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12635__$1);
}
}
})();
