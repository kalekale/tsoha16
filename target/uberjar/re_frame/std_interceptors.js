...
var vec__17211_17214 = clojure.data.diff(orig_db,new_db);
var only_before_17215 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17211_17214,(0),null);
var only_after_17216 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17211_17214,(1),null);
var db_changed_QMARK__17217 = (cljs.core.some_QMARK_(only_before_17215)) || (cljs.core.some_QMARK_(only_after_17216));
if(db_changed_QMARK__17217){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before: ",only_before_17215], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after : ",only_after_17216], 0));
...
var map__17224 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__17224__$1 = ((((!((map__17224 == null)))?((((map__17224.cljs$lang$protocol_mask$partition0$ & (64))) || (map__17224.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17224):map__17224);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17224__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17224__$1,cljs.core.cst$kw$event);
...
var map__17232 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__17232__$1 = ((((!((map__17232 == null)))?((((map__17232.cljs$lang$protocol_mask$partition0$ & (64))) || (map__17232.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17232):map__17232);
var coeffects = map__17232__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17232__$1,cljs.core.cst$kw$event);
...
var len__7379__auto___17235 = arguments.length;
var i__7380__auto___17236 = (0);
while(true){
if((i__7380__auto___17236 < len__7379__auto___17235)){
args__7386__auto__.push((arguments[i__7380__auto___17236]));

var G__17237 = (i__7380__auto___17236 + (1));
i__7380__auto___17236 = G__17237;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7387__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq17234){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17234));
});
...
var args__7386__auto__ = [];
var len__7379__auto___17243 = arguments.length;
var i__7380__auto___17244 = (0);
while(true){
if((i__7380__auto___17244 < len__7379__auto___17243)){
args__7386__auto__.push((arguments[i__7380__auto___17244]));

var G__17245 = (i__7380__auto___17244 + (1));
i__7380__auto___17244 = G__17245;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7387__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__17238_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__17239_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__17239_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq17240){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__17241,G__17242,seq17240__$2);
});
