...
re_frame.subs.query__GT_reaction = (function (){var G__17248 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__17248) : cljs.core.atom.call(null,G__17248));
})();
/**
...
var G__17251 = re_frame.subs.query__GT_reaction;
...
var args17253 = [];
var len__7379__auto___17256 = arguments.length;
var i__7380__auto___17257 = (0);
while(true){
if((i__7380__auto___17257 < len__7379__auto___17256)){
args17253.push((arguments[i__7380__auto___17257]));

var G__17258 = (i__7380__auto___17257 + (1));
i__7380__auto___17257 = G__17258;
continue;
} else {
}
break;
...
var args17260 = [];
var len__7379__auto___17267 = arguments.length;
var i__7380__auto___17268 = (0);
while(true){
if((i__7380__auto___17268 < len__7379__auto___17267)){
args17260.push((arguments[i__7380__auto___17268]));

var G__17269 = (i__7380__auto___17268 + (1));
i__7380__auto___17268 = G__17269;
continue;
} else {
}
break;
...
var temp__4657__auto___17271 = cljs.core.not_empty(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(re_frame.interop.ratom_QMARK_,dynv));
if(cljs.core.truth_(temp__4657__auto___17271)){
var not_reactive_17272 = temp__4657__auto___17271;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$warn,cljs.core.array_seq(["re-frame: your subscription's dynamic parameters that don't implement IReactiveAtom: ",not_reactive_17272], 0));
} else {
}
} else {
}
...
return (function (){
var G__17263 = re_frame.db.app_db;
var G__17264 = v;
var G__17265 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(dyn_vals) : cljs.core.deref.call(null,dyn_vals));
return (handler_fn.cljs$core$IFn$_invoke$arity$3 ? handler_fn.cljs$core$IFn$_invoke$arity$3(G__17263,G__17264,G__17265) : handler_fn.call(null,G__17263,G__17264,G__17265));
...
return (function (){
var G__17266 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(sub) : cljs.core.deref.call(null,sub));
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__17266) : cljs.core.deref.call(null,G__17266));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7084__auto__ = (function re_frame$subs$map_vals_$_iter__17291(s__17292){
return (new cljs.core.LazySeq(null,(function (){
var s__17292__$1 = s__17292;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__17292__$1);
if(temp__4657__auto__){
var s__17292__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__17292__$2)){
var c__7082__auto__ = cljs.core.chunk_first(s__17292__$2);
var size__7083__auto__ = cljs.core.count(c__7082__auto__);
var b__17294 = cljs.core.chunk_buffer(size__7083__auto__);
if((function (){var i__17293 = (0);
while(true){
if((i__17293 < size__7083__auto__)){
var vec__17303 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7082__auto__,i__17293);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17303,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17303,(1),null);
cljs.core.chunk_append(b__17294,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(val) : f.call(null,val))], null));

var G__17309 = (i__17293 + (1));
i__17293 = G__17309;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__17294),re_frame$subs$map_vals_$_iter__17291(cljs.core.chunk_rest(s__17292__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__17294),null);
}
} else {
var vec__17306 = cljs.core.first(s__17292__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17306,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17306,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(val) : f.call(null,val))], null),re_frame$subs$map_vals_$_iter__17291(cljs.core.rest(s__17292__$2)));
}
} else {
return null;
}
...
var len__7379__auto___17323 = arguments.length;
var i__7380__auto___17324 = (0);
while(true){
if((i__7380__auto___17324 < len__7379__auto___17323)){
args__7386__auto__.push((arguments[i__7380__auto___17324]));

var G__17325 = (i__7380__auto___17324 + (1));
i__7380__auto___17324 = G__17325;
continue;
} else {
}
break;
...
return re_frame.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7387__auto__);
});
...
var inputs_fn = (function (){var G__17312 = cljs.core.count(input_args);
switch (G__17312) {
case (0):
return ((function (G__17312,computation_fn,input_args,err_header){
return (function() {
var G__17327 = null;
var G__17327__1 = (function (_){
return re_frame.db.app_db;
});
var G__17327__2 = (function (_,___$1){
return re_frame.db.app_db;
});
G__17327 = function(_,___$1){
switch(arguments.length){
case 1:
return G__17327__1.call(this,_);
case 2:
return G__17327__2.call(this,_,___$1);
}
...
;})(G__17312,computation_fn,input_args,err_header))
...
return ((function (ret_val,G__17312,computation_fn,input_args,err_header){
return (function() {
...
;})(ret_val,G__17312,computation_fn,input_args,err_header))
...
return ((function (pairs,vecs,ret_val,G__17312,computation_fn,input_args,err_header){
return (function() {
var re_frame$subs$inp_fn = null;
var re_frame$subs$inp_fn__1 = (function (_){
return ret_val;
...
;})(pairs,vecs,ret_val,G__17312,computation_fn,input_args,err_header))
...
return (function (){
var G__17318 = re_frame.subs.deref_input_signals(subscriptions,query_id);
var G__17319 = query_vec;
return (computation_fn.cljs$core$IFn$_invoke$arity$2 ? computation_fn.cljs$core$IFn$_invoke$arity$2(G__17318,G__17319) : computation_fn.call(null,G__17318,G__17319));
...
return re_frame.interop.make_reaction(((function (subscriptions,computation_fn,input_args,err_header,inputs_fn){
return (function (){
var G__17320 = re_frame.subs.deref_input_signals(subscriptions,query_id);
var G__17321 = query_vec;
var G__17322 = dyn_vec;
return (computation_fn.cljs$core$IFn$_invoke$arity$3 ? computation_fn.cljs$core$IFn$_invoke$arity$3(G__17320,G__17321,G__17322) : computation_fn.call(null,G__17320,G__17321,G__17322));
});})(subscriptions,computation_fn,input_args,err_header,inputs_fn))
);
});
...
re_frame.subs.reg_sub.cljs$lang$applyTo = (function (seq17310){
var G__17311 = cljs.core.first(seq17310);
var seq17310__$1 = cljs.core.next(seq17310);
return re_frame.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic(G__17311,seq17310__$1);
});
